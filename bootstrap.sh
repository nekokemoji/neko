...
NEKO_SOURCE_COMMIT="79f50b900f1e509a6fdfd3d341d1080820c83e6b"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.5.0……\n'
...
grep -Fq 'NEKO_RELEASE="1.5.0"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.5.0。"
