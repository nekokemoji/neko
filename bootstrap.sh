...
NEKO_SOURCE_COMMIT="3534385999bffcdc2727c176c03c4c935ec177b0"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.11.1……\n'
...
grep -Fq 'NEKO_RELEASE="1.11.1"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.11.1。"
