...
NEKO_SOURCE_COMMIT="564dad9e9bc8f84d9c3ef457f5e9bd2b2d69e37c"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.5.1……\n'
...
grep -Fq 'NEKO_RELEASE="1.5.1"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.5.1。"
