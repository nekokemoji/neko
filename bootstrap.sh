...
NEKO_SOURCE_COMMIT="74f3ea6bcb68040e85f9702e0e2d45525c77ec0d"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.7.1……\n'
...
grep -Fq 'NEKO_RELEASE="1.7.1"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.7.1。"
