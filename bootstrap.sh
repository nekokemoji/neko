...
NEKO_SOURCE_COMMIT="2eea4daaac8a392edbe8828716d54730f912a89c"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.5.2……\n'
...
grep -Fq 'NEKO_RELEASE="1.5.2"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.5.2。"
