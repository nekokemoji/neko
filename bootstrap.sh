...
NEKO_SOURCE_COMMIT="a65b504a66fa4d4df9f9ccae6a74db44544ad562"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.13.1……\n'
...
grep -Fq 'NEKO_RELEASE="1.13.1"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.13.1。"
