...
NEKO_SOURCE_COMMIT="71984e3b70808a6bb9933489535447571e7970c2"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.11.0……\n'
...
for required_file in \
  ...
  runtime/panel.sh runtime/route-diagnostics.sh runtime/renew.sh runtime/hysteria-dual.sh \
...
grep -Fq 'NEKO_RELEASE="1.11.0"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.11.0。"
