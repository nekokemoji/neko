...
NEKO_SOURCE_COMMIT="fcf558e26113f4ebe5e4e3b2823de4e02f6b63dd"
...
if [[ -n "$NEKO_BOOTSTRAP_ARCHIVE" ]]; then
  ...
  printf '[信息] 正在从 GitHub 下载固定版本 Neko 1.6.0……\n'
...
grep -Fq 'NEKO_RELEASE="1.6.0"' "$WORKDIR/source/versions.env" \
  || die_bootstrap "下载的项目版本不是预期的 Neko 1.6.0。"
